...
def len_longest_palindromic_substring_naive(s):
        ...
        if len(s) > 0:
            for start in range(len(s)):
                for end in range(start, len(s)):
                    if end - start + 1 > result and _is_palindrome(s, start, end):
                        result = end - start + 1
        return result
...
def len_longest_palindromic_substring_dp_suboptimal(s):
    if isinstance(s, str):
        if len(s) == 0:
            return 0
        n = len(s)
...
def len_longest_palindromic_substring_dp(s):
    if isinstance(s, str):
        if len(s) == 0:
            return 0
        n = len(s)
...
# Time Complexity: O(n**2), where n is the length of the string.
# Space Complexity: O(1).
def len_longest_palindromic_substring(s):
...
def len_longest_palindromic_substring_manacher(s):
    if isinstance(s, str):
...
string_list = ["abracadabra",
               ...
               "",
               None]
fns = [len_longest_palindromic_substring_naive,
       len_longest_palindromic_substring_dp_suboptimal,
       len_longest_palindromic_substring_dp,
       len_longest_palindromic_substring,
       len_longest_palindromic_substring_manacher]
