...
#
# This basic approach simply sorts (with reverse order) the list then returns the first k elements from the (sorted)
# lists.
#
...
#       largest elements is not guaranteed; only that they are the largest elements.
#
# This approach creates a min heap of size k from the first k items in the list, then pushes and pops (one at a time)
# each of the remaining list items.  Once this is done the min heap, or the k largest elements, are returned.
#
