"""
    FIND (THE) KTH LARGEST ELEMENT (IN A LIST) (EPI 12.8)
...
def find_kth_largest_element_via_quick_select(l, k):
    ...
    if l is not None and k is not None and 0 < k <= len(l):
        ...
        _find_kth_largest_element_via_quick_select(l, k, 0, len(l)-1)   # DIFFERENT THAN QUICK SELECT
...
fns = [find_kth_largest_element_via_sorted, find_kth_largest_element_via_min_heap,
